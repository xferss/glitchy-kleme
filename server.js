...
client.on(`guildMemberAdd`, async member => {
  const e = new Discord.RichEmbed()
    ...
    .addField(`Sunucumuza geldiğin için teşekkür ederim!`, `GoBeL iyi eğlenceler diler`)
    .addField(`Davet Linkleri;`, `[Botu Sunucuna Eklemek için Tıkla] (https://discord.com/oauth2/authorize?client_id=709686712451858453&scope=bot&permissions=2146958847)\n[https://https://discord.gg/g4TSjU](DESTEK)`)
    .setFooter(`Bu Sunucu 7/24 GoBeL tarafından korunuyor.`)
  member.send(e);
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'ip') {
		if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
			msg.author.sendMessage('ensanw.mcoyna.com'); 
		} else {
		msg.reply('ensanw.mcoyna.com ');
		}
	}
});
...
client.on("message", message => {
    ...
    client.channels.get("711849945455657001").send(dmlog);
    }
});
client.on("message", message => {
if (message.content === ayarlar.prefix+"say") {
 ...
 client.on('message', msg => {
 if (msg.content.toLowerCase() === '587939579038793728') {
